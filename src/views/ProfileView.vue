    ...
    withdrawBid(nft) {
      ...
      this.$store.state.biddingContract.methods
        ...
        .catch((error) => {
          ...
          _this.$store.dispatch(
            "error",
            "Something went wrong whilst withdrawing your funds from the bid!"
          );
          _this.$store.state.isLoading = false;
        });
    },
    revertTokenOwnership() {
      ...
      this.$store.state.biddingContract.methods
        ...
        .catch((error) => {
          ...
          _this.$store.dispatch(
            "error",
            "Something went wrong whilst transferring token ownership back to you please try again!"
          );
          _this.$store.state.isLoading = false;
        });
    },
      ...
      if (tempEndDate > tempStartDate) {
        ...
        this.$store.state.biddingContract.methods
          ...
          .catch((error) => {
            ...
            _this.$store.dispatch(
              "error",
              "Something went wrong whilst listing token for bidding"
            );
          });
      } else {
        this.$store.dispatch(
    ...
    getUserPlacedBids() {
      ...
      this.$store.state.biddingContract.methods
        ...
        .catch((error) => {
          ...
          _this.$store.dispatch(
            "error",
            "Something went wrong whilst fetching your placed bids!"
          );
          _this.$store.state.isLoading = false;
        });
    },
    cancelBid(nft) {
      ...
      this.$store.state.biddingContract.methods
        ...
        .catch((error) => {
          ...
          _this.$store.dispatch(
            "error",
            "Something went wrong whilst cancelling bid"
          );
        });
    },
    getSelected($state) {
